...
import demo.orangehrmlive.com.pages.*;
...
public class UsersTest extends BaseTest {
    ...
    public void adminShouldAddUserSuccessFully(){
        ...
        verifyExpectedAndActual(By.xpath("//h6[normalize-space()='Add User']"),"Add User");
        ...
        verifyExpectedAndActual(By.linkText("Successfully Saved"),"Successfully Saved");
    ...
    public void searchTheUserCreatedAndVerifyIt(){
        ...
        homePage.clickOnAdminTab();
        String expectedMessage = "System Users";
        verifyExpectedAndActual(By.xpath("//h5[normalize-space()='System Users']"),"System Users");
        ...
        verifyExpectedAndActual(By.xpath("//span[normalize-space()='(1) Record Found']"),"(1) Record Found");
